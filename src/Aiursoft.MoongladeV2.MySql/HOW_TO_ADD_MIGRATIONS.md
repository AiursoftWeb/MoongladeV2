...
1. Navigate to the MySQL project directory:
   ```bash
   cd ./src/Aiursoft.MoongladeV2.MySql/
   ```
...
```bash
dotnet ef migrations remove --context "MySqlContext" -s ../Aiursoft.MoongladeV2/Aiursoft.MoongladeV2.csproj
```

## After Creating Migrations

After creating migrations for MySQL, remember to:
1. Create the corresponding migration for SQLite (see `../Aiursoft.MoongladeV2.Sqlite/HOW_TO_ADD_MIGRATIONS.md`)
