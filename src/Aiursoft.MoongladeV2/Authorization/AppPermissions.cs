...
public class AppPermissions
{
    ...
    public static List<PermissionDescriptor> GetAllPermissions()
    {
        ...
        [
            ...
            new(AppPermissionNames.CanManageComments,
                localizer["Manage Comments"],
                localizer["Allows viewing, approving, and deleting comments on blog posts."]),
            new(AppPermissionNames.CanManageCustomPages,
                localizer["Manage Custom Pages"],
                localizer["Allows creating, editing, publishing, and deleting custom pages."]),
            new(AppPermissionNames.CreateEditOrDeleteDraftDocument,
                localizer["Create, Edit, and Delete Any Draft"],
                localizer["Allows creating, editing, and deleting any draft post. Cannot publish, unpublish, edit, or delete published posts."]),
            new(AppPermissionNames.CreateEditOrPublishAnyDocument,
                localizer["Create, Edit, and Publish Any Post"],
                localizer["Allows creating, editing, publishing, and deleting any post. Full content management."]),
