...
public class AppPermissions
{
    ...
    public static List<PermissionDescriptor> GetAllPermissions()
    {
        ...
        [
            ...
            new(AppPermissionNames.CanWritePost,
                localizer["Write Posts"],
                localizer["Allows creating and editing blog posts."]),
            new(AppPermissionNames.CanPublishPost,
                localizer["Publish Posts"],
                localizer["Allows publishing blog posts to the public."]),
